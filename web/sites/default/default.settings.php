...
$settings['s3fs.use_s3_for_public'] = false; //change to true
$config['s3fs.settings']['bucket'] = 'capdel';

$config['maps.settings']['api_key'] = '';

// please adjust according to your host on DEV environments
$settings['trusted_host_patterns'] = array(
  '^www\.capdel\.test$',
);

//SmartSupp Live Chat settings
$config['chat.settings']['active'] = false;
$config['chat.settings']['key'] = '';

// please add GTM id to track the tags
$settings['google_tag_manager_id'] = 'GTM-XXXXXX';
