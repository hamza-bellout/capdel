...
class ContactForm extends FormBase
{
  ...
  const MAIL_TO = 'contact@capdel.fr';
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['marketing'] = [
      ...
      '#title' => $this->t('En cochant la case, vous acceptez expressément de recevoir des actualités,
                    bon plans, conseils et pépites de CAPDEL par email conformément à <a href="/notice" target="_blank">notre politique de confidentialité.</a>'),
    ];
