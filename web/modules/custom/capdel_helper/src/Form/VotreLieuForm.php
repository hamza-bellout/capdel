 ...
 * Time: 12:14
 */
class VotreLieuForm extends FormBase
{

  const MAIL_TO = 'myplace@capdel.fr';
  const MAIL_SUBJECT = 'Venue finding <company_name> <full_name>';
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['description'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Description de la demande').' *',
      '#required' => TRUE,
    ];
  ...
  private function getEmailBody(array $form, FormStateInterface $form_state){
    ...
    $body = "<p>Demande Venue Finding</p>";
